      ...
      <main className="bg-gray-50 dark:bg-gray-900 pt-8 pb-16">
        ...
        <div className="container mx-auto px-4 mb-6">
          <nav className="flex items-center text-sm text-gray-500 dark:text-gray-400">
            ...
            {categoryInfo && (
              <>
                <Link href={categoryInfo.href} className="hover:text-gray-900 dark:hover:text-white">
                  {categoryInfo.name}
                </Link>
                <ChevronRight className="h-4 w-4 mx-2" />
              </>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
              ...
              <div className="space-y-4">
                <div className="relative h-96 bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden">
                  <Image
                    src={product.gallery?.[selectedImage] || product.image || "/placeholder.svg?height=384&width=384"}
                    alt={product.name}
                    fill
              ...
              <div className="space-y-6">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <Heart className={cn("h-5 w-5", isInFavorites(product.id) && "fill-red-500")} />
                            </button>
                          </TooltipTrigger>
                          <TooltipContent>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-gray-900 dark:text-white">Livraison</h4>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Livraison estimée: {product.shipping?.estimatedDelivery || "2-5 jours ouvrés"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-gray-900 dark:text-white">Garantie</h4>
                      <p className="text-xs text-gray-500 dark:text-gray-400">{product.warranty || "Garantie 1 an"}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 px-6 py-8">
              <Tabs defaultValue="details">
                ...
                <TabsContent value="specs" className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {product.dimensions && (
                        <div className="space-y-2">
                          <h4 className="font-medium text-gray-900 dark:text-white">Dimensions</h4>
                          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-2">
                            ...
                            <div className="flex justify-between">
                              <span className="text-gray-500 dark:text-gray-400">Hauteur</span>
                              <span className="text-gray-900 dark:text-white">{product.dimensions.height} cm</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-500 dark:text-gray-400">Profondeur</span>
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="text-gray-900 dark:text-white">{product.dimensions.weight} kg</span>
                            </div>
                          </div>
                        </div>
                      )}
                      ...
                      {product.materials && product.materials.length > 0 && (
                        <div className="space-y-2">
                          <h4 className="font-medium text-gray-900 dark:text-white">Matériaux</h4>
                      ...
                      {/* SKU & Stock */}
                      <div className="space-y-2">
                        <h4 className="font-medium text-gray-900 dark:text-white">Informations produit</h4>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-2">
                          <div className="flex justify-between">
                            <span className="text-gray-500 dark:text-gray-400">Référence (SKU)</span>
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-500 dark:text-gray-400">Date d'ajout</span>
                ...
                <TabsContent value="shipping" className="space-y-6">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Livraison</h3>
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-4">
                      <div className="flex items-start">
                        <Truck className="h-5 w-5 text-yellow-500 mr-3 flex-shrink-0 mt-0.5" />
                        <div>
                          <h4 className="font-medium text-gray-900 dark:text-white">Délais de livraison</h4>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-medium text-gray-900 dark:text-white">Informations de livraison</h4>
                          <p className="text-gray-600 dark:text-gray-300 mt-1">
                            Dimensions du colis: {product.shipping?.dimensions || "N/A"}
                          </p>
                          <p className="text-gray-600 dark:text-gray-300">
                            Poids du colis: {product.shipping?.weight || "N/A"} kg
                          </p>
                          <p className="text-gray-600 dark:text-gray-300">
                            Méthode d'expédition: {product.shipping?.method || "Standard"}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Politique de retour</h3>
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                      <p className="text-gray-600 dark:text-gray-300">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mt-2">
                        ...
                        <Link href="/retours" className="text-yellow-600 dark:text-yellow-400 hover:underline">
                          politique de retour
                        </Link>
                        .
                      </p>
              ...
              {relatedProducts.map((relatedProduct) => (
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    <Image
                      src={relatedProduct.image || "/placeholder.svg?height=192&width=256"}

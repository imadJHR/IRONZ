...
export default function DemandeDevisPage(): JSX.Element {
  ...
  const budgetOptions: BudgetOption[] = [
    {
      value: "8000-25000",
      label: "8 000 MAD - 25 000 MAD",
      icon: <DollarSign className="w-4 h-4" />,
    },
    {
      value: "28000-35000",
      label: "28 000 MAD - 35 000 MAD",
      icon: <DollarSign className="w-4 h-4" />,
    },
    {
      value: "35000-50000",
      label: "35 000 MAD - 50 000 MAD",
      icon: <DollarSign className="w-4 h-4" />,
    },
    {
      value: "100000-plus",
      label: "Plus de 100 000 MAD",
      icon: <DollarSign className="w-4 h-4" />,
    },
    {
      value: "a-definir",
      label: "À définir avec notre équipe",
  ...
  const processSteps = [
    {
      step: "1",
      title: "Formulaire",
      desc: "Remplissez votre demande",
      icon: <FileText className="w-5 h-5" />,
    },
    {
      step: "2",
      title: "Analyse",
      desc: "Étude par notre équipe d'experts",
      icon: <User className="w-5 h-5" />,
    },
    {
      step: "3",
      title: "Devis",
      desc: "Proposition personnalisée",
      icon: <DollarSign className="w-5 h-5" />,
    },
    {
      step: "4",
      title: "Validation",
      desc: "Démarrage du projet",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="sticky top-32 space-y-8">
                  <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-8 shadow-lg">
                    ...
                    <div className="space-y-6">
                      {processSteps.map((item) => {
                        const isActive = currentStep >= Number(item.step);
                  ...
                  <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 dark:from-yellow-500/5 dark:to-orange-500/5 border border-yellow-500/20 dark:border-yellow-500/10 rounded-3xl p-8">
                    ...
                    <div className="space-y-4">
                      <a
                        href="tel:+212674114446"
                        className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors group"
                      >
              ...
              {/* Right Column - Form */}
              <motion.div variants={itemVariants} className="lg:col-span-2" ref={formRef}>
                {isSubmitted ? (
                  <motion.div
                              ...
                              <textarea
                                ...
                                className={`w-full px-5 py-4 rounded-2xl border-2 ${
                                  errors.message
                                    ? "border-red-500"
                                    : "border-gray-200 dark:border-gray-700"
                                } bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:border-yellow-500 transition-colors resize-none`}
                          ...
                          >
                            ...
                            <div className="mb-10">
                              <label className="flex items-start gap-3 cursor-pointer">
                                <div
                                  className={`flex-shrink-0 w-5 h-5 mt-1 border-2 rounded ${
                                    formData.terms
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              ...
              gratuite et sans engagement avec nos experts.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#form-section"

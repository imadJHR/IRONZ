...
const MAX_TOTAL_PAYLOAD_SIZE: number = 5.5 * 1024 * 1024;
...
export default function AddProductPage(): JSX.Element {
  ...
  const showNotification = (message: string, type: ToastState['type'] = 'success'): void => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>): Promise<void> => {
    ...
    try {
      ...
      if (totalSize > MAX_TOTAL_PAYLOAD_SIZE) {
        throw new Error(
          `Total file size too large (${(totalSize / 1024 / 1024).toFixed(2)}MB). Limit is 5.5MB.`
        );
      }
      ...
      const newProductId: string | undefined = createdProduct._id || createdProduct.id;

      if (addReview && newProductId) {
        const reviewPayload = {
          username: reviewData.username,
          rating: parseInt(String(reviewData.rating)),
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Add New Product</h1>
                  <p className="text-gray-500 mt-2 text-lg">
                    Create amazing products for{' '}
                    <span className="text-yellow-600 font-bold">Ironz</span>
                  </p>
                </div>
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className={`p-3 rounded-lg ${isActive ? 'bg-white/10' : 'bg-gray-100'}`}>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-100">
                  ...
                  <span className={`font-bold ${completion === '80%' ? 'text-green-600' : 'text-yellow-600'}`}>
                    {completion}
                  </span>
                </div>
              </div>
          ...
          <div className="lg:col-span-2">
              ...
              <div className="p-6 border-b border-gray-100 bg-gray-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-500 mt-1">Fill in the details for your product</p>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="space-y-2">
                                ...
                                <p className="text-sm text-gray-500">
                                  {((mainImage?.size ?? 0) / (1024 * 1024)).toFixed(2)} MB
                                </p>
                              </div>
                              <button
                                type="button"
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500 mt-2">
                                Up to 10 images, {MAX_FILE_SIZE_MB}MB each
                              </p>
                            </div>
                            <button
                              type="button"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-6 p-4 rounded-xl bg-gray-50 border border-gray-200">
                      {(
                        [
                          { name: 'isNewProduct', label: 'New Product', color: 'bg-yellow-500' },
                          { name: 'isFeatured', label: 'Featured', color: 'bg-yellow-500' },
                          { name: 'inStock', label: 'In Stock', color: 'bg-green-500' },
                        ] as { name: keyof FormData; label: string; color: string }[]
                    ...
                    <>
                      ...
                      <div className="space-y-6">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          {(
                            [
                              { id: 'width', label: 'Width (cm)', icon: Ruler, step: undefined },
                              { id: 'height', label: 'Height (cm)', icon: Ruler, step: undefined },
                              { id: 'depth', label: 'Depth (cm)', icon: Ruler, step: undefined },
                              { id: 'weight', label: 'Weight (kg)', icon: Scale, step: '0.1' },
                            ] as { id: keyof FormData; label: string; icon: LucideIcon; step?: string }[]
                          ).map(({ id, label, icon: Icon, step }) => (
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              onKeyPress={(e) =>
                                handleKeyPress(e, materials, setMaterials, newMaterial, setNewMaterial, 'materials')
                              }
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                handleAddItem(taille, setTaille, newTaille, setNewTaille, 'sizes')
                              }
                              className="px-6 py-3 rounded-xl bg-black text-white font-bold hover:bg-gray-800 transition-all duration-300"
                            >
                              <Plus className="w-5 h-5" />
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                All fields marked with <span className="text-red-500">*</span> are required. Make sure
                to review all information before publishing.
              </p>
            </div>
          </div>
        </div>

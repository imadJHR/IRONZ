  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-black gap-4">
        ...
        <p className="text-yellow-500 font-bold tracking-widest text-sm animate-pulse">
          SECURING CONNECTION...
        </p>
      </div>
    );
      ...
      <div className="hidden lg:flex w-1/2 bg-black relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center p-12">
          ...
          <p className="text-gray-400 text-lg max-w-md mx-auto leading-relaxed">
            Plateforme de gestion centralisée. Contrôlez votre boutique en un seul endroit.
          </p>
        </div>
      </div>
          ...
          <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-gray-100 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-900 uppercase tracking-wide ml-1">
                  Identifiant
                </label>

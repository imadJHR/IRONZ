...
// Import de l'image (assurez-vous que le chemin est correct dans votre projet)
              ...
              <div className="relative h-[400px] lg:h-auto">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex justify-center gap-4">
                    <a href="https://www.facebook.com/muscle.ironz" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm flex items-center justify-center text-white transition-colors">
                      <FaFacebook className="w-5 h-5" />
                    </a>
                    <a href="https://www.instagram.com/ironz_official/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm flex items-center justify-center text-white transition-colors">
                      <FaInstagram className="w-5 h-5" />
                    </a>
                    <a href="https://www.youtube.com/@muscleironz8921" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm flex items-center justify-center text-white transition-colors">
                    ...
                    {formStatus.error && (
                      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
                        <Alert variant="destructive" className="bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800">
                          ...
                          <AlertDescription className="text-red-700 dark:text-red-300">{formStatus.error}</AlertDescription>
                        </Alert>
                      </motion.div>
                    )}
                      ...
                      <RadioGroup value={formState.contactReason} onValueChange={(value) => setFormState((prev) => ({ ...prev, contactReason: value }))} className="flex flex-wrap gap-4">
                        {[
                          ...
                          <div key={option.value} className="flex items-center space-x-2">
                            <RadioGroupItem value={option.value} id={option.value} className="border-gray-300 data-[state=checked]:bg-yellow-500" />
                            <Label htmlFor={option.value} className="cursor-pointer text-sm font-medium">{option.label}</Label>
                          </div>
                        ))}
                      </RadioGroup>
                    </div>

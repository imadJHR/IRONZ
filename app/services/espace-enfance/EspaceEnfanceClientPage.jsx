...
import { ArrowLeft, CheckCircle, Heart, Shield, Users, Send, ArrowRight, Star, Play, X } from "lucide-react"
...
export default function EspaceEnfanceClientPage() {
  ...
  const solutions = {
    ...
    minigym: {
      title: "Mini gym",
      description: "Des équipements de fitness adaptés à la morphologie et aux capacités des enfants.",
      image: "/placeholder.svg?height=400&width=600&text=Mini+gym",
      features: ["Appareils cardio taille enfant", "Poids et résistances adaptés", "Design coloré et attrayant"],
    },
    escalade: {
      ...
      features: ["Hauteurs adaptées aux enfants", "Prises colorées et thématiques", "Matelas de réception sécurisés"],
    },
    interactif: {
      ...
      features: ["Jeux vidéo actifs", "Sols et murs interactifs", "Défis et récompenses virtuels"],
    },
  }
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            >
              Créez des espaces fitness ludiques et sécurisés pour les enfants, favorisant leur développement physique
              et leur bien-être.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
          ...
          <FadeInWhenVisible>
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
                Des espaces fitness <span className="gradient-text">adaptés aux enfants</span>
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Nous concevons et aménageons des espaces fitness spécialement pensés pour les enfants, alliant sécurité,
                plaisir et développement moteur.
              </p>
            </div>
          </FadeInWhenVisible>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FadeInWhenVisible delay={0.1}>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl border-b-4 border-transparent hover:border-yellow-400">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Sécurité & Confort</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Des espaces conçus avec des matériaux sécurisés et adaptés aux enfants, pour un environnement sans
                  risque.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Revêtements de sol amortissants</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Équipements aux normes de sécurité</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
            ...
            <FadeInWhenVisible delay={0.2}>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl border-b-4 border-transparent hover:border-yellow-400">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Ludique & Éducatif</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Des espaces qui stimulent l'imagination et l'apprentissage tout en encourageant l'activité physique.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Parcours moteurs ludiques</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Jeux interactifs et éducatifs</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Zones thématiques adaptées aux âges</span>
                  </li>
                </ul>
              </div>
            </FadeInWhenVisible>
            ...
            <FadeInWhenVisible delay={0.3}>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl border-b-4 border-transparent hover:border-yellow-400">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Inclusif & Adapté</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Des espaces accessibles à tous les enfants, quelles que soient leurs capacités, pour favoriser
                  l'inclusion.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Équipements adaptés à tous les âges</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 dark:text-gray-300">Activités adaptées à différents niveaux</span>
                  </li>
                </ul>
              </div>
            </FadeInWhenVisible>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInWhenVisible>
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
                Nos <span className="gradient-text">solutions</span> pour les enfants
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Découvrez notre gamme complète d'équipements et d'aménagements spécialement conçus pour les enfants.
              </p>
            </div>
          </FadeInWhenVisible>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                <div className="relative h-64 md:h-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                    <div className="p-6">
                      <h3 className="text-2xl font-heading font-bold text-white mb-2">{solutions[activeTab].title}</h3>
                    </div>
                  </div>
                </div>
                <div className="p-8 md:p-10 flex flex-col justify-center">
                  <h3 className="text-2xl font-heading font-bold mb-4">{solutions[activeTab].title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-6">{solutions[activeTab].description}</p>
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeInWhenVisible>
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
                Les <span className="gradient-text">bienfaits</span> pour les enfants
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Découvrez comment nos espaces fitness contribuent au développement et au bien-être des enfants.
              </p>
            </div>
          </FadeInWhenVisible>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInWhenVisible>
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Découvrez les témoignages de nos clients qui ont fait confiance à IRONZ PRO pour l'aménagement de leurs
                espaces enfance.
              </p>
            </div>
          </FadeInWhenVisible>
              ...
              <FadeInWhenVisible key={index} delay={index * 0.1}>
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300 relative">
                  <div className="absolute top-0 right-0 transform translate-x-1/4 -translate-y-1/4">
                    <div className="text-8xl text-yellow-200 dark:text-yellow-900/20 font-serif">"</div>
                  </div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 italic mb-4 relative z-10">"{testimonial.quote}"</p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <FadeInWhenVisible>
                <div>
                  <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
                    Prêt à créer un <span className="gradient-text">espace fitness</span> pour enfants?
                  </h2>
                  <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                    Contactez-nous dès aujourd'hui pour discuter de votre projet. Notre équipe d'experts vous
                    accompagnera à chaque étape, de la conception à la réalisation.
                  </p>
                  <div className="space-y-6 mb-8">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">+33 (0)1 23 45 67 89</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mr-4 flex-shrink-0 animate-pulse-glow">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">contact@ironzpro.fr</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mr-4 flex-shrink-0 animate-pulse-glow">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">123 Avenue des Sports, 75001 Paris, France</p>
                      </div>
                    </div>
                  </div>
              ...
              <FadeInWhenVisible delay={0.2}>
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 border-t-4 border-yellow-400">
                  <h3 className="text-2xl font-heading font-bold mb-6">Contactez-nous</h3>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-yellow-400 to-yellow-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              Transformez votre espace en un lieu d'apprentissage et de plaisir pour les enfants
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Nos experts sont prêts à vous accompagner dans la création d'un espace fitness adapté aux enfants, alliant
              sécurité, plaisir et développement.
            </motion.p>
            <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Spécialiste de l'aménagement d'espaces fitness professionnels et adaptés à tous les publics.
              </p>
              <div className="flex space-x-4">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/a-propos" className="text-gray-400 hover:text-yellow-400 transition-colors">
                    À propos
                  </Link>
                </li>
                <li>
                  <Link href="/produits" className="text-gray-400 hover:text-yellow-400 transition-colors">
                    Produits
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/promotions" className="text-gray-400 hover:text-yellow-400 transition-colors">
                    Promotions
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">123 Avenue des Sports, 75001 Paris, France</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-5 h-5 text-yellow-400 mr-3 mt-0.5"

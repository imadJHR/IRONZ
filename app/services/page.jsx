...
import { CheckCircle, Users, Truck, PenToolIcon as Tool, Shield, Award } from "lucide-react"
...
export const metadata = {
  ...
  description: "Découvrez les services professionnels proposés par IRONZ PRO pour votre équipement de fitness",
}
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      icon: <Tool className="h-10 w-10 text-yellow-500" />,
      features: ["Diagnostic complet", "Réparation rapide", "Pièces d'origine", "Contrats de maintenance"],
    ...
    },
    {
      ...
      features: ["Programmes sur mesure", "Suivi nutritionnel", "Coaching à domicile", "Séances en visio"],
    ...
    },
    {
      ...
      description: "Prolongez la durée de garantie de vos équipements pour une tranquillité d'esprit totale.",
    ...
    },
    {
      ...
      features: ["Étude personnalisée", "Plans 3D", "Sélection d'équipements", "Suivi de projet"],
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              Nos <span className="text-yellow-400">Services</span> Professionnels
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Découvrez notre gamme complète de services pour vous accompagner dans votre parcours fitness, de
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Nous proposons une gamme complète de services pour répondre à tous vos besoins en matière d'équipement
              fitness
            </p>
          </div>
            ...
            {services.map((service) => (
              ...
              >
                <div className="p-6">
                  ...
                  <Button className="w-full bg-yellow-400 hover:bg-yellow-500 text-black">{service.cta}</Button>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-100 dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">Notre Processus</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center relative z-10">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Évaluation</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Nos experts évaluent votre demande et vous proposent des solutions adaptées.
                </p>
              </div>
              <div className="hidden lg:block absolute top-1/2 left-full w-full h-0.5 bg-yellow-400 transform -translate-y-1/2 -translate-x-8 z-0"></div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center relative z-10">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Planification</h3>
                <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center relative z-10">
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Réalisation</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Nos techniciens interviennent pour réaliser le service demandé.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-yellow-500 text-sm">Service d'installation</p>
                </div>
              </div>
              <p className="text-gray-600 dark:text-gray-400 italic">
                "L'équipe d'installation a été très professionnelle et efficace. Mon home gym a été installé en moins de
                2 heures, avec des conseils d'utilisation très utiles."
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-yellow-500 text-sm">Coaching personnalisé</p>
                </div>
              </div>
              <p className="text-gray-600 dark:text-gray-400 italic">
                "Le coaching personnalisé m'a permis de tirer le meilleur parti de mon équipement. Mon coach a su
                adapter les exercices à mes objectifs et mes contraintes."
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-400 italic">
                "Le service de maintenance est impeccable. Intervention rapide et efficace, mon tapis de course
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Nous intervenons généralement sous 48 à 72h après validation du devis. Pour les zones rurales, le
                  délai peut être légèrement plus long.
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Oui, nos services sont disponibles dans toute la France métropolitaine. Pour les DOM-TOM, veuillez
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  La première séance commence par un bilan complet (objectifs, condition physique, contraintes).
                  Ensuite, votre coach élabore un programme sur mesure et vous accompagne dans sa réalisation.
                </p>
              </div>

              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                <h3 className="text-xl font-heading font-bold mb-3">Que couvre l'extension de garantie ?</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Notre extension de garantie couvre les pièces, la main d'œuvre et le déplacement en cas de panne. Elle
                  inclut également un service prioritaire et un remplacement temporaire pour certains équipements.
                </p>
              </div>
            </div>
          </div>

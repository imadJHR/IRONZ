...
const services: Service[] = [
  {
    ...
    description:
      "Analyse de vos besoins, étude de l'espace disponible et conception de plans détaillés.",
    features: [
...
const processSteps: ProcessStep[] = [
  {
    ...
    description:
      "Analyse approfondie de vos besoins et objectifs spécifiques",
  ...
  },
  {
    ...
    description:
      "Élaboration de plans détaillés et visualisations 3D de votre futur espace",
  ...
  },
  {
    ...
    description:
      "Finalisation du projet et établissement du calendrier d'exécution",
  ...
  },
  {
    ...
    description:
      "Exécution des travaux d'aménagement et installation professionnelle",
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-950">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Des solutions d&apos;aménagement adaptées à tous les types
              d&apos;espaces et besoins spécifiques
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-950">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Une approche méthodique et transparente pour garantir la réussite
              de votre projet
            </p>
          </motion.div>
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  {index < processSteps.length - 1 && (
                    <div className="hidden md:block absolute left-8 top-full w-0.5 h-6 bg-gradient-to-b from-yellow-500/50 to-transparent" />
                  )}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed">
                Contactez notre équipe d&apos;experts IRONZ pour une
                consultation gratuite et sans engagement. Nous vous
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-black/90 mb-10 max-w-2xl mx-auto">
              Découvrez comment nos solutions d&apos;aménagement peuvent
